...
\item better understanding about what is it that makes a seiyuu popular in terms of MAL users.
\end{itemize}
\end{frame}
%-------------------------------------------------------------------------
...
\item Find a better metric to compare popularity prediction results.
\item Improve models and data for better popularity predictions.
